    ...
    <section className="py-20 bg-gradient-to-br from-slate-50 to-white" id="about">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Right Column - Image Carousel and Book */}
          <div className="flex flex-col items-center justify-center space-y-8">
            {/* Self Development Book by Sairam */}
            <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-slate-200/50 p-6 text-center">
              <div className="mb-4">
                <img 
                  src="/images/BYB.png" 
                  alt="Being Your Best Book" 
                  className="w-24 h-32 object-cover rounded-lg mx-auto shadow-md"
                />
              </div>
