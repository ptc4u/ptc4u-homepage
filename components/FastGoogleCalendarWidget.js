...
const FastGoogleCalendarWidget = () => {
  const [showFallback, setShowFallback] = useState(false);

  useEffect(() => {
    // Show fallback after 5 seconds if calendar doesn't load
  ...
  return (
    <div className="w-full h-full bg-white relative">
      ...
      {/* Google Calendar iframe - Monthly View */}
      <iframe
...
export default FastGoogleCalendarWidget;
