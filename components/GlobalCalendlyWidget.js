...
export default function GlobalCalendlyWidget() {
  return (
    <div className="fixed right-4 top-1/2 transform -translate-y-1/2 z-50 hidden lg:block">
      <div className="calendar-widget-container bg-white rounded-2xl border border-purple-200/30 shadow-2xl p-2 overflow-hidden" style={{ width: '380px', height: '600px' }}>
        {/* Header */}
