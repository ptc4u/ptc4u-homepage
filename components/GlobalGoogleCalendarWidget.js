...
export default function GlobalGoogleCalendarWidget() {
  return (
    <div className="absolute right-8 top-1/3 transform -translate-y-1/4 z-50 hidden lg:block bg-white rounded-2xl shadow-2xl p-2 max-w-sm" style={{ maxWidth: '320px', maxHeight: '400px' }}>
      {/* Booking Tag */}
      ...
      <div className="calendar-widget-container bg-gradient-to-b from-blue-400 to-blue-500 rounded-2xl shadow-2xl border-4 border-blue-600 overflow-hidden backdrop-blur-sm bg-white" style={{ width: '320px', height: '320px' }}>
        {/* Header */}
        <div className="bg-blue-600 px-4 py-3 text-center border-b border-blue-700 rounded-t-2xl">
