...
export default function GlobalGoogleCalendarWidget() {
  return (
    <div className="fixed right-0 top-1/3 transform -translate-y-1/4 z-50 hidden lg:block">
      {/* Booking Tag */}
      ...
      <div className="bg-gradient-to-b from-blue-400 to-blue-500 rounded-2xl shadow-2xl border-4 border-blue-600 overflow-hidden backdrop-blur-sm" style={{ width: '320px', height: '320px' }}>
        {/* Header */}
        ...
        <div className="h-full overflow-hidden rounded-b-2xl relative bg-white/10 backdrop-blur-sm" style={{ fontSize: '10px' }}>
          <iframe
