...
export default function GlobalGoogleCalendarWidget() {
  return (
    <div className="fixed right-8 top-1/3 transform -translate-y-1/4 z-50 hidden lg:block bg-white rounded-2xl shadow-2xl p-2 max-w-sm" style={{ maxWidth: '320px', maxHeight: '400px' }}>
      {/* Booking Tag */}
