...
export default function JourneyFormSection() {
  ...
  return (
    <section className="pb-6 bg-gradient-to-br from-purple-50 via-white to-emerald-50 rounded-2xl shadow-lg flex items-center justify-center min-h-screen" id="journey" style={{ paddingTop: '160px' }}>
