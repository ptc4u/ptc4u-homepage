...
export default function JourneyOptionsSection() {
  ...
  return (
    <section className="pt-12 pb-16 bg-gradient-to-br from-blue-50 to-purple-50" id="journey-options">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="flex items-start space-x-8">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-lg font-semibold text-black mb-3">{option.subtitle}</p>
        ...
        {/* Thin Bar Buttons */}
        <div className="flex flex-col sm:flex-row gap-6 max-w-5xl mx-auto mt-10">
          <button
