...
/**
 * Mobile dropdown component that appears in the bottom right corner
 * Contains navigation items, social media links, and quick action buttons
 */
      ...
      {isOpen && (
        <div className="absolute bottom-16 right-0 w-80 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-4">
            <h3 className="font-bold text-lg">PTC Menu</h3>
            <p className="text-blue-100 text-sm">Navigate & Connect</p>
          </div>
            ...
            <div className="space-y-2">
              {navigationItems.map((item) => (
                <button
                  ...
                  className="w-full text-left px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg transition-colors duration-200 flex items-center"
                >
          ...
          <div className="p-4">
            <h4 className="font-semibold text-gray-700 mb-3 text-sm uppercase tracking-wide">Connect With Us</h4>
            <div className="flex items-center justify-center space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 bg-white rounded-lg flex items-center justify-center hover:bg-blue-50 transition-all duration-300 hover:scale-110 shadow-md border border-gray-200"
                  onClick={() => setIsOpen(false)}
                >
                  {social.icon}
                </a>
          ...
          <div className="p-4 bg-gray-50 border-t border-gray-100">
            <div className="space-y-2">
              <a
                ...
                className="flex items-center w-full text-left px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded-lg transition-colors duration-200"
                onClick={() => setIsOpen(false)}
              >
                <svg className="w-5 h-5 mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-sm font-medium">ask@ptc4u.com</span>
              </a>
              <a
