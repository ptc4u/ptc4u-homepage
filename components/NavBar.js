        ...
        <div className="grid grid-cols-3 items-center h-20 gap-4">
          ...
          <div className="flex justify-start">
            <button
              ...
              className="p-2 rounded-md text-slate-700 hover:text-blue-600 hover:bg-blue-50/50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors duration-200"
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="space-y-1">
                <button
                  ...
                  className="w-full text-left px-4 py-3 text-slate-800 hover:text-blue-600 hover:bg-gradient-to-r hover:from-gray-100 hover:to-gray-50 rounded-lg transition-all duration-200 font-medium border border-transparent hover:border-gray-200/50"
                >
                  About Your Coach
                </button>
                <button
                ...
                <div className="pt-2 mt-2 border-t border-gray-300/60">
                  ...
                  <a
                    ...
                    className="flex items-center w-full px-4 py-3 text-slate-800 hover:text-blue-600 hover:bg-gradient-to-r hover:from-gray-100 hover:to-gray-50 rounded-lg transition-all duration-200 border border-transparent hover:border-gray-200/50"
                  >
