  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen bg-neutral-50 relative z-50">
        ...
        <main className="flex-grow pt-28 sm:pt-32 lg:pt-36 px-4 sm:px-6 lg:px-8 lg:pl-16 lg:pr-16 pb-24 overflow-y-auto flex items-center justify-center" style={{ height: 'calc(100vh - 80px)' }}>
          <BlogsSection />
        </main>
