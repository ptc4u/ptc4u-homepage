    ...
    <>
      ...
      <div className="min-h-screen" style={{ background: 'var(--gradient-bg)' }}>
        ...
        <div className="fixed right-4 top-1/2 -translate-y-1/2 z-40 hidden md:block">
          <div className="bg-white border-2 border-purple-600 rounded-lg shadow-xl px-4 py-3">
        ...
        <div className="fixed bottom-4 right-4 z-40 md:hidden">
          <div className="bg-white border-2 border-purple-600 rounded-lg shadow-xl px-3 py-2">
            <VisitorCounter />
          </div>
        </div>
      </div>
