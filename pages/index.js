  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen bg-neutral-50 relative z-50">
        ...
        <main className="flex-grow px-4 sm:px-6 lg:px-8 lg:pl-16 lg:pr-16 pb-24 overflow-y-auto pt-16 sm:pt-20 lg:pt-24 flex flex-col" style={{ height: 'calc(100vh - 80px)' }}>
          <div id="hero">
            <HeroSection />
          </div>
